...
import 'c6_agreement_add_model.dart';
export 'c6_agreement_add_model.dart';

class C6AgreementAddWidget extends StatefulWidget {
  const C6AgreementAddWidget({
    super.key,
    this.notifAddAgreeClient,
  });

  final NotificationRecord? notifAddAgreeClient;

  @override
  State<C6AgreementAddWidget> createState() => _C6AgreementAddWidgetState();
}

class _C6AgreementAddWidgetState extends State<C6AgreementAddWidget> {
  late C6AgreementAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => C6AgreementAddModel());
      ...
      child: Container(
        ...
        child: StreamBuilder<List<FilesRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            final columnFilesRecord = columnFilesRecordList.isNotEmpty
                ? columnFilesRecordList.first
                : null;
                            ...
                            onPressed: () async {
                              await FilesRecord.collection
                                  ...
                                  .set(createFilesRecordData(
                                    ...
                                    type: 'file',
                                    downloadUrl: _model.uploadedFileUrl,
                                    isDeleted: false,
                              ...
                              await NotificationRecord.collection
                                  ...
                                  .set(createNotificationRecordData(
                                    userId: columnFilesRecord?.userRef,
                                    fileId: columnFilesRecord?.reference,
