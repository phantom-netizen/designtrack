...
import 'c6_invoice_add_model.dart';
export 'c6_invoice_add_model.dart';

class C6InvoiceAddWidget extends StatefulWidget {
  const C6InvoiceAddWidget({
    super.key,
    this.addInvoiceClient,
  });

  final NotificationRecord? addInvoiceClient;

  @override
  State<C6InvoiceAddWidget> createState() => _C6InvoiceAddWidgetState();
}

class _C6InvoiceAddWidgetState extends State<C6InvoiceAddWidget> {
  late C6InvoiceAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => C6InvoiceAddModel());
