...
import 'c3_tracker_model.dart';
export 'c3_tracker_model.dart';

class C3TrackerWidget extends StatefulWidget {
  const C3TrackerWidget({
    super.key,
    this.projectName,
  });
  ...
  @override
  State<C3TrackerWidget> createState() => _C3TrackerWidgetState();
}

class _C3TrackerWidgetState extends State<C3TrackerWidget> {
  late C3TrackerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => C3TrackerModel());
  }
