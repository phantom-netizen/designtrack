...
import '/designer/d3_tracker/d3_tracker_widget.dart';
...
import 'd1_home_model.dart';
export 'd1_home_model.dart';

class D1HomeWidget extends StatefulWidget {
  const D1HomeWidget({super.key});

  @override
  State<D1HomeWidget> createState() => _D1HomeWidgetState();
}

class _D1HomeWidgetState extends State<D1HomeWidget>
    with TickerProviderStateMixin {
  late D1HomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D1HomeModel());
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 44.0, 16.0, 22.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('D91ProfileScreen');
                            },
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(40.0),
                              child: Image.network(
                              ...
                              child: CarouselSlider(
                                items: [
                                  ClipRRect(
                                    ...
                                    child: Image.asset(
                                      'assets/images/440377409_830192152477455_7894617002241023907_n.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/441513739_839616778201659_2433747795471824985_nadas.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/440374141_831362042360466_5303609919465258329_n.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/444484709_839534658209871_4849641896583767774_n.jpg',
                                      width: 300.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(20.0, 17.0, 0.0, 0.0),
                child: Container(
                  width: 278.0,
                  height: 33.0,
                  decoration: BoxDecoration(
                                                                      ...
                                                                      valueOrDefault<
                                                                        ...
                                                                        formatNumber(
                                                                          valueOrDefault<int>(
                                                                              ...
                                                                              valueOrDefault<int>(
                                                                                (currentUserDocument?.tasks.toList() ?? []).length,
                                                                                0,
                                                                              ),
                                                                          formatType:
                                                                              FormatType.percent,
