...
import 'd7_design_add_model.dart';
export 'd7_design_add_model.dart';

class D7DesignAddWidget extends StatefulWidget {
  const D7DesignAddWidget({super.key});

  @override
  State<D7DesignAddWidget> createState() => _D7DesignAddWidgetState();
}

class _D7DesignAddWidgetState extends State<D7DesignAddWidget> {
  late D7DesignAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D7DesignAddModel());
