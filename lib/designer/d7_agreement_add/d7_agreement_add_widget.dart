...
import 'd7_agreement_add_model.dart';
export 'd7_agreement_add_model.dart';

class D7AgreementAddWidget extends StatefulWidget {
  const D7AgreementAddWidget({super.key});

  @override
  State<D7AgreementAddWidget> createState() => _D7AgreementAddWidgetState();
}

class _D7AgreementAddWidgetState extends State<D7AgreementAddWidget> {
  late D7AgreementAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D7AgreementAddModel());
