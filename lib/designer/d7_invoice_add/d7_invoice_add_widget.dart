...
import 'd7_invoice_add_model.dart';
export 'd7_invoice_add_model.dart';

class D7InvoiceAddWidget extends StatefulWidget {
  const D7InvoiceAddWidget({super.key});

  @override
  State<D7InvoiceAddWidget> createState() => _D7InvoiceAddWidgetState();
}

class _D7InvoiceAddWidgetState extends State<D7InvoiceAddWidget> {
  late D7InvoiceAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => D7InvoiceAddModel());
